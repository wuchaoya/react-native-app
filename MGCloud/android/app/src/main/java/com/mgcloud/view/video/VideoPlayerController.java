...
/**
 * VideoPlayerController 封装VideoPlayer控制器
...
public class VideoPlayerController extends FrameLayout implements
    ...
    public void setPlayState(PlayState playState) {
        mPlayImg.setImageResource(playState.equals(PlayState.PLAY) ? R.mipmap.video_pause
                : R.mipmap.video_play);
    }
    ...
    private void initView(Context context) {
        View.inflate(context, R.layout.video_player_controller, this);
